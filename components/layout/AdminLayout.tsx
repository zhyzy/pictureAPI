...
type AdminIconName = 'dashboard' | 'categories' | 'apis' | 'images' | 'videos' | 'users' | 'settings' | 'update';
...
const adminIconPaths: Record<AdminIconName, string> = {
  ...
  videos: 'M21 7.5v9a1.5 1.5 0 01-1.5 1.5h-11A1.5 1.5 0 017 16.5v-9A1.5 1.5 0 018.5 6h11A1.5 1.5 0 0121 7.5zm-13.5 3L3 8.25v7.5L7.5 13.5m4.5-2.25l3 1.875-3 1.875v-3.75z',
...
export default function AdminLayout({ children, title }: AdminLayoutProps) {
  ...
  const navItems = [
    ...
    { href: '/admin/videos', label: '视频管理', icon: 'videos' as const },
              ...
              <Link href="/" className="flex items-center gap-2">
                {siteSettings.site_logo ? (
                  ...
                  <div className="w-7 h-7 bg-[var(--color-primary)] rounded flex items-center justify-center text-white text-sm font-serif font-bold">
                    {siteSettings.site_name.charAt(0) || 'Z'}
                  </div>
                )}
